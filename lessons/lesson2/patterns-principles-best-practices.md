...
Сначала нужно увидеть не термин, а факт:
...
Только после этого можно назвать такой способ организации кода:
...
### Когда один класс не делает все сразу
...
### Когда вход, логика и выход не лежат в одной куче
...
### Когда контракт API выражен явно
