...
## Какой шаблон программирования здесь изучается

Здесь продолжается знакомство с:

### Layered Architecture

Но теперь уже на более реалистичном create use case:
...
## Какие принципы проектирования здесь важны
