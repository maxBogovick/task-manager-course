...
- понимание, почему один класс не должен делать все сразу
- понимание, почему controller и service лучше разделять
- понимание, почему DTO лучше, чем `Map`
- базовое понимание, почему зависимости лучше не создавать через `new`
- и только после этого названия этих идей: архитектурный стиль, принципы проектирования и best practices
